...
import com.example.scholarix.ui.navigation.BottomNavItem
import com.example.scholarix.ui.navigation.ProviderBottomNavigation
import com.example.scholarix.ui.screens.common.ChangePasswordActivity
...
import com.example.scholarix.ui.screens.student.AccountListItem
import com.example.scholarix.ui.screens.student.ProfileInfoItem
...
class ProviderProfileActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ScholarixTheme {
                ProviderProfileScreen(userViewModel, profileViewModel)
            }
        }
    }
...
fun ProviderProfileScreen(
    ...
    Scaffold(
        bottomBar = {
            ProviderBottomNavigation(selected = BottomNavItem.Profile)
        }
    ) { paddingValues ->
        Box(
            modifier = Modifier
            ...
            if ((isUserLoading && userModel == null) || (isProfileLoading && profileModel == null)) {
                ...
                Column(
                    ...
                    Text(
                        text = if (fullName.isNotEmpty()) "Hello, $fullName!" else "Hello!",
                        fontSize = 24.sp,
                        fontWeight = FontWeight.Bold,
                        color = PrimaryBlue,
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            // Part 2: Organization Details (with Heading)
                            ...
                            ProfileInfoItem(
                                ...
                                value = profileModel?.organizationType
                            )
                            HorizontalDivider(color = Background.copy(alpha = 0.5f), thickness = 1.dp)
